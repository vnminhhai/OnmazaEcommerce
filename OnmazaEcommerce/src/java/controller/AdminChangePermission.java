...
public class AdminChangePermission extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        new CustomerDAO().updatePermission(cid, permission);
        request.setAttribute("mess1", "Updated permission for ID "+ cid);
        request.setAttribute("mess2", "The user is now a "+(permission==0?"Admin":(permission==1?"Staff":"Normal user")));
