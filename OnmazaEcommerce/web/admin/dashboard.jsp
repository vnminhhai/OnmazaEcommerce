<%-- 
    Document   : dashboard
    Created on : Mar 21, 2024, 4:55:21 AM
    Author     : ADMIN
--%>
...
<div id="title" class="center mt-5">
	<h1>FEB 2024</h1>
	<p>Holidays and Daily Observances in the United States</a>
</div>

<div class="calendar-frame center">
    <div class="day-frame placeholder bg-white" style="cursor: auto"></div>
	<div class="day-frame placeholder bg-white" style="cursor: auto"></div>
	...
	<div class="day-frame center real" id='twenty-eight'>
        ...
        <div class="day-frame center real" id='twenty-nine'>
            ...
            <div class="day-label center">Leap Day</div>
        </div>
	<div class="day-frame placeholder bg-white" style="cursor: auto"></div>
	<div class="day-frame placeholder bg-white" style="cursor: auto"></div>
	<div class="day-frame placeholder bg-white" style="cursor: auto"></div>
